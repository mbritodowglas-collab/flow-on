...
function buildMonthlyReport(year, month){
  ...
  const periodISO = (d)=> toISO(new Date(year, month, d));
...
function init(){
  ...
  document.getElementById('btnBuildMonth').onclick = ()=>{
    ...
    // enable actions
    document.getElementById('btnDLMonthMD').disabled = false;
    document.getElementById('btnDLMonthCSV').disabled = false;
    document.getElementById('btnCopyMonth').disabled = false;
    // bind downloads
  ...
  document.getElementById('btnBuildQuarter').onclick = ()=>{
    ...
    document.getElementById('btnDLQuarterMD').disabled = false;
    document.getElementById('btnCopyQuarter').disabled = false;
