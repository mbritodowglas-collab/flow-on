// assets/js/include-layout.js  — v2 (safe)
// Injeta Topbar + Dock SOMENTE nas páginas dentro de /pages/*
// Não toca na Home (index.html) e não quebra nada se algo faltar.

(function () {
  // Se NÃO estiver em /pages/, não faz nada (Home permanece como está)
  ...
  document.addEventListener('DOMContentLoaded', () => {
    try {
      ...
      // Base para links até a raiz
      // Estrutura atual usa /pages/<secao>/  (um nível)
      // Se futuramente tiver níveis a mais, aumente os "../"
      const base = '../../';
      ...
      console.warn('[include-layout] falhou, mantendo layout da página.', e);
    }
  });
})();